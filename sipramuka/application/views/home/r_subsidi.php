          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="wellcome-text">
              <div class="well-text text-center">
                ...
                <p class="title3">
                  "Rumah subsidi adalah hunian atau tempat tinggal yang tidak dikenakan pajak plus memiliki bunga rendah, kemudian ditujukan untuk masyarakat berpenghasilan rendah agar dapat memiliki tempat tinggal layak huni." 
                </p>
                 </div>
                  <?php echo form_open('home/searchsubsidi') ?>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              ...
              <div>
                <?php echo anchor('ar_subsidi/detail_subsidi/'.$ar->id_subsidi,'<span class="btn btn-primary" >Lihat Selengkapnya</span>'
                )?>
              </div>
            </div>
          </div>
