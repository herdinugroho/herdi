            ...
            <div class="card card-primary">
              <div >
                ...
                <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active">Rukost</li>
                </ol>
              </div>
            </div>
              ...
              <section class="content">
                <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Tambah Data Rukost</button>
                <table class="table">
                  <tr>
                    <th>NO</th>
                    <th>NAMA RUKOST</th>
                  ...
                  <tr>
                    ...
                    <td onclick="javascript:return confirm ('Anda Yakin Akan Menghapus ?')"><?php echo anchor('ar_rukost/hapus/'.$ar->id_rukost,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></div>') ;?>
                    </td>
                    <td><?php echo anchor('ar_rukost/edit/'.$ar->id_rukost,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>');?>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php  echo form_open_multipart('ar_rukost/tambah_aksi');?>          
          <div class="form-group">
            <label>Nama Rukost</label>
