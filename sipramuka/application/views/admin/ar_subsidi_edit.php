...
<div class="content-wrapper">
  <section class="content">
    <?php foreach ($tb_subsidi as $ar){?>
  <?php echo form_open_multipart('ar_subsidi/update');?>
      <div class="form-group">
        <label>Nama Rumah</label>
        <input type="hidden" name="id_subsidi" class="form-control" value="<?php echo $ar->id_subsidi ?>">
