          <!-- general form elements -->
           <!-- general form elements -->
            <div class="card card-primary">
              <div >
                <h3 ><b>Tanah Kavling</b></h3>
                <ol class="breadcrumb">
                 <li class="breadcrumb-item active">Home</li>
                  <li class="breadcrumb-item active">Property</li>
                 <li class="breadcrumb-item active">Tanah Kavling</li>
                </ol>
              </div>
            </div>
              ...
              <section class="content">
                <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Tambah Data Kavling</button>
                <table class="table">
                  <tr>
                    <th>NO</th>
                    <th>NAMA KAVLING</th>
                  ...
                  <tr>
                    ...
                    <td onclick="javascript:return confirm ('Anda Yakin Akan Menghapus ?')"><?php echo anchor('ar_kavling/hapus/'.$ar->id_kavling,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></div>') ;?>
                    </td>
                    <td><?php echo anchor('ar_kavling/edit/'.$ar->id_kavling,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>');?>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php  echo form_open_multipart('ar_kavling/tambah_aksi');?>          
