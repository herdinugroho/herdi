          <!-- general form elements -->
            ...
            <div class="card card-primary">
              <div >
                <h3 ><b>Rumah Subsidi</b></h3>
                <ol class="breadcrumb">
                 <li class="breadcrumb-item active">Home</li>
                  <li class="breadcrumb-item active">Property</li>
                 <li class="breadcrumb-item active">Rumah Subsidi</li>
                </ol>
              </div>
            </div>
              ...
              <section class="content">
                <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Tambah Data Subsidi</button>
                <table class="table">
                  <tr>
                    <th>NO</th>
                    <th>NAMA RUMAH</th>
                  ...
                  <tr>
                    ...
                    <td onclick="javascript:return confirm ('Anda Yakin Akan Menghapus ?')"><?php echo anchor('ar_subsidi/hapus/'.$ar->id_subsidi,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></div>') ;?>
                    </td>
                    <td><?php echo anchor('ar_subsidi/edit/'.$ar->id_subsidi,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>');?>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php  echo form_open_multipart('ar_subsidi/tambah_aksi');?>          
