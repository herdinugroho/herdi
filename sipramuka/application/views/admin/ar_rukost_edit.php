...
<div class="content-wrapper">
  <section class="content">
    <?php foreach ($tb_rukost as $ar){?>
  <?php echo form_open_multipart('ar_rukost/update');?>
      <div class="form-group">
        <label>Nama Rumah</label>
        <input type="hidden" name="id_rukost" class="form-control" value="<?php echo $ar->id_rukost ?>">
