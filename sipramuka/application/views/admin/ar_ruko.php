            ...
            <div class="card card-primary">
              <div >
                ...
                <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active">Ruko</li>
                </ol>
              </div>
            </div>
              ...
              <section class="content">
                <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Tambah Data Ruko</button>
                <table class="table">
                  <tr>
                    <th>NO</th>
                    <th>NAMA RUKO</th>
                  ...
                  <tr>
                    ...
                    <td onclick="javascript:return confirm ('Anda Yakin Akan Menghapus ?')"><?php echo anchor('ar_ruko/hapus/'.$ar->id_ruko,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></div>') ;?>
                    </td>
                    <td><?php echo anchor('ar_ruko/edit/'.$ar->id_ruko,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>');?>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php  echo form_open_multipart('ar_ruko/tambah_aksi');?>          
