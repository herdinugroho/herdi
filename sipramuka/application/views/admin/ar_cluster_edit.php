...
<div class="content-wrapper">
  <section class="content">
    <?php foreach ($tb_cluster as $ar){?>
  <?php echo form_open_multipart('ar_cluster/update');?>
      <div class="form-group">
        <label>Nama Rumah</label>
        <input type="hidden" name="id_cluster" class="form-control" value="<?php echo $ar->id_cluster ?>">
