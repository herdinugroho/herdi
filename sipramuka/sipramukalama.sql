...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2020 at 09:49 AM
...
(30, 28, 'admin', '', 'dsassad'),
(38, 0, 'Sipa Amaliah', 'herdi.nugroho19@gmail.com', 'ajnsxnskax'),
(39, 0, 'tai', '', 'mjsax'),
(40, 0, 'scac', '', 'scacsac');
...
--
-- Table structure for table `tb_ruko`
--

CREATE TABLE `tb_ruko` (
...
--
-- Dumping data for table `tb_ruko`
--
...
--
-- Table structure for table `tb_rukost`
--

CREATE TABLE `tb_rukost` (
...
--
-- Dumping data for table `tb_rukost`
--
...
--
-- Table structure for table `tb_subsidi`
--

CREATE TABLE `tb_subsidi` (
...
--
-- Dumping data for table `tb_subsidi`
--
...
--
ALTER TABLE `tb_profil`
  MODIFY `id_profil` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
